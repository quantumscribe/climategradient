...
import jsonData from './tropospheric.json';
  ...
  useEffect(() => {
    ...
    function drawChart(options) {
      ...
      const yScale = d3.scaleLinear()
        .domain([-0.5, d3.max(data, d => d.Tem)])
        .nice()
        .range([height, 0]);
  ...
  return (
    <div>
      <div style={{ position: 'relative' }}>
        <h2 className="text-xl font-bold text-white-800 px-4 py-2 border-b border-white-200">Tropospheric Temperature</h2>

...
import jsonData from './stratospheric.json';
  ...
  return (
    <div>
      <div style={{ position: 'relative' }}>
        <h2 className="text-xl font-bold text-white-800 px-4 py-2 border-b border-white-200">Stratospheric Temperature</h2>

						...
						<div className='grid lg:grid-cols-3 md:grid-cols-2 grid-rows-2 gap-5 w-full place-content-center px-4 py-2 text-slate-900'>
							<div>
								<TiltCard
									...
									CardPara='Visualize CO2 emissions globally: Understand impact, embrace sustainability, drive change.'
									location='/co2'
								/>
							</div>
							<div>
								<TiltCard
									CardTitle='Global Temperature'
									CardPara='Explore Global Temperature Trends: Visualize Climate Change Over Decades'
									location='/globaltemp'
								/>
							</div>
							<div>
								<TiltCard
									CardTitle='Sea Level'
									CardPara="Dive into Sea Level Shifts: Visualize the Ocean's Changing Landscape"
									location='/sealevel'
								/>
							</div>

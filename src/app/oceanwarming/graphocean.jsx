  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-10">
      <div style={{ position: 'relative' }}>
        <h2 className="text-xl font-bold text-white-800 px-4 py-2 border-b border-white-200">Yearly Rise in Ocean Warming</h2>

  ...
  useEffect(() => {
    ...
    function drawChart(options) {
      ...
      const yScale = d3.scaleLinear()
        .domain([300, d3.max(data, d => d.CO2ppm)])
        .nice()
        .range([height, 0]);
      ...
      svg.on('mousemove', function(event) {
        ...
        const CO2ppmAtMouseY = yScale.invert(mouseY);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-10">
      <div style={{ position: 'relative' }}>
        <h2 className="text-xl font-bold text-white-800 px-4 py-2 border-b border-white-200">CO2 Data Visualization</h2>

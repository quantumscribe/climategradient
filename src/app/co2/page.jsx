...
<p className='text-calibiri text-justify font-bold bg-clip-text text-transparent bg-gradient-to-b from-yellow-700 to-yellow-100'>
  ...
  Efforts to mitigate the impacts of rising CO2 levels include transitioning to renewable energy sources, improving energy efficiency, reforestation and afforestation initiatives, and implementing carbon capture and storage technologies.
      ...
      <div>wrapping up cards
      
      <div className="flex justify-center ">
<div className="card w-64 h-48 bg-gradient-to-b from-yellow-700 to to-white tw-shadow-colored rounded-lg cursor-pointer transition-transform hover:translate-y-1 ml-4">
  <div className="card-content p-4">
    <span className="text-white font-bold" style={{ backgroundImage: '-webkit-linear-gradient(#FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
      <h3 className="font-sans serif">CLIMATE CHANGE</h3>
      <p className='font-s text-calibiri text-justify font-bold bg-clip-text text-transparent bg-gradient-to-b from-black to-white'> CO2 is naturally present in Earth's atmosphere as a trace gas, currently comprising about 0.04% (410 parts per million) of the atmosphere by volume.</p>
    </span>
  </div>
</div>  
...
<div className="card w-64 h-48 bg-gradient-to-b from-yellow-700 to to-white tw-shadow-colored rounded-lg cursor-pointer transition-transform hover:translate-y-1 ml-4">
  <div className="card-content p-4">
    <span className="text-white font-bold" style={{ backgroundImage: '-webkit-linear-gradient(#FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
      <h3 className="font-sans serif">ANOTHER CARD</h3>
      <p>INFORMATION.</p>
    </span>
  </div>
</div>
  ...
  <div className="card-content p-4">
    <span className="text-white font-bold" style={{ backgroundImage: '-webkit-linear-gradient(#FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
      ...
      <p>INFORMATION.</p>
        ...
        <div>number of divs=no. of cards
          <div>text design,gradient etc etc</div>
        </div>
      </div>
    </div>
  </div>

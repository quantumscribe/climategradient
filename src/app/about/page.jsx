	...
	return (
		<div>
			<div
				...
				style={{
					backgroundImage:
						"url('https://t3.ftcdn.net/jpg/03/18/13/92/360_F_318139202_s4F1cp8hP5U3YpZmHLjozJHTebmj5Pbo.jpg')",
				}}>
				...
				<div className='container mx-auto px-6'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
						<div className='flex items-center justify-center'>
							<img
								src='https://cdn.pixabay.com/photo/2016/11/29/04/19/ocean-1867285_640.jpg'
								alt='Our Mission'
						...
						{teamMembers.map((member, index) => (
							<div
								...
								<div className='bg-gray-100 rounded-lg shadow-lg p-4 transform transition-transform hover:scale-105 duration-300'>
									...
									/>
									<h3 className='text-lg md:text-xl text-black font-semibold text-center'>
										{member.name}
									</h3>
									...
									<div className='flex justify-center mt-2 md:mt-4'>
										<a
											...
											className='mx-1 md:mx-2 text-gray-600 hover:text-blue-500'>
